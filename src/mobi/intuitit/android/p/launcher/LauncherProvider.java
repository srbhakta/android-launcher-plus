...
import mobi.intuitit.android.p.launcher.LauncherSettings.Favorites;
...
public class LauncherProvider extends ContentProvider {
    ...
    static final String AUTHORITY = "mobi.intuitit.android.p.launcher.settings";
    
    static final String EXTRA_BIND_SOURCES = "mobi.intuitit.android.p.launcher.settings.bindsources";
    static final String EXTRA_BIND_TARGETS = "mobi.intuitit.android.p.launcher.settings.bindtargets";
